			...
			<form  id="fileUpload" action="${rc.contextPath}/dorm/dormInfo/opt-import/importGoodDormList.do" method="post"  enctype="multipart/form-data">
				 ...
				 <input type="hidden" name="maxSize" value="2097152"/><!--2M-->
				  <div class="formSep">
					<div class="row-fluid">
					  <div class="span9">
						<div class="span2">文明宿舍导入</div>
						<div class="span8">
					 		<div>
				 				<a href="${rc.contextPath}/excel/template/import_dorm_good_template.xls">文明宿舍导入模板</a>
				    		</div>
				    	</div>
				      </div>
			    	</div>
			     ...
			     <div class="formSep">
					 <div class="row-fluid">
						 <div class="span9">						
							<div class="span2">
								<label>文明宿舍信息<span class="f_req">*</span></label>
							</div>
							<div class="span10" id="_upload_div">					
						         ...
						         <div class="alert alert-warning">
					    		    ...
					    		    <br>2.最大导入行数为1000行。
					    		    <br>3.导入的各条数据之间不要有空行。
					    		    <br>4.文明宿舍将以宿舍编号作为唯一标识进行比对，导入前请确认宿舍编号无误。
				...
				<div class="row-fluid">
					<div class="span9">						
						<div class="span2">&nbsp;</div>
						<div class="span8">
							<button class="btn btn-info" type="button" onclick="importGoodDormList()">Excel导入</button>
