<table class="table table-bordered table-striped tablecut" id="selectUserTable">
	...
	<#if page??>
		<#list page.result as student>
			<tr>
			    <td><input type="radio" name="row_sel"  value="${(student.studentInfo)!""}" <#if selectedId?? && selectedId == student.id>checked="true"</#if> onclick="_onClickClassStudentRadio(this)"/></td>
...
<div class="row-fluid">
<div class="span12" style="margin-top:-19px;" id="_radioSelectStudentPage">
	<div class="nextP">
...
<div id="pageClassRadioFormDiv" name="pageClassRadioFormDiv" style="display:none">
</div>
<script >
$("document").ready(function(){
	...
	pageForm.action="${rc.contextPath}/comp/student/nsm/querySteudentByClass.do";
	pageForm.id="pageFormId";
	document.getElementById("pageClassRadioFormDiv").appendChild(pageForm);	
	...
	$("#pageClassRadioFormDiv").append($("#pageFormId"));
	...
	$("#_radioSelectStudentPage #gotoPageNumber").keypress(function(event){
	
		var maxPageNo= $("#_radioSelectStudentPage #gotoPageTotalPageCount").val()*1;
		var toPageNo= $("#_radioSelectStudentPage #gotoPageNumber").val()*1;
