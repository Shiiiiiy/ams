<form class="editMenuForm">
	<div class="formSep">
		...
		<div class="row-fluid">
			...
			<div class="span5"><input type="text" value="${org.name}" id="name_" ></div>
		</div>
		<div class="row-fluid">
			<div class="span3">组织机构编码 <span class="f_req">*</span></div>
			<div class="span5"><input type="text" value="${org.code}" id="code_" ></div>
		</div>
		<div class="row-fluid">
		...
		<div class="row-fluid">
			...
			<div class="span5"><input type="text" value="${(org.area!"")?html}" id="area_" ></div>
		</div>
		<div class="row-fluid">
			<div class="span3">备注: </div>
			<div class="span5"><input type="text" value="${(org.comments!"")?html}" id="comments_" ></div>
		</div>
