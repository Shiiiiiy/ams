    	...
    	<div class="row-fluid">	
			<form  id="userQuery"  action="${rc.contextPath}/user/user/opt-query/queryUser.do" method="post">
				<div class="span12">			
					<div class="row-fluid">
						<div class="span4">
							<span class="formTitle">用户姓名</span>
							<input id="userName" name="userName" class="span6" value="${user.userName!""}"  />
						</div>
						<#--
						<div class="span4">
							<span class="formTitle">&nbsp;&nbsp;&nbsp;登录名</span>
							<input id="loginName" name="loginName" class="span8"  value="${user.loginName!""}" />
						</div>
						-->
						<div class="span4">
							<span class="formTitle">用户类型</span>
							<select size="1" id="userTypeId" name="userTypeId" aria-controls="dt_gal"  class="span6">
						...
						<div class="span4">
							<span class="formTitle">用户状态</span>
							<select size="1" id="userStatus" name="userStatus" aria-controls="dt_gal"  class="span6">
								<option value="">请选择..</option>
					...
					<div class="row-fluid">
						...
						<div class="span4">
							...
							<select size="1" id="gender" name="gender" aria-controls="dt_gal"  class="span8">
								<option value="">请选择..</option>
								<#if dicGender??  >
									<#if  user.gender?? >
							...
							<#if page??>
								<#list page.result as user>
									...
									<tr>
										...
										<td rowspan="${rol}"  class="autocut">${user.name}<#--<a href="###" onclick="viewUser('${user.id}')"></a>--></td>
										<#--
