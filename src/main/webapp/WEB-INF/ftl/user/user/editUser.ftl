...
<div id="contentwrapper">
    <div class="main_content">
    	<#if user.id?? >
			<h3 class="heading">修改用户</h4>
		<#else>
			<h3 class="heading">新增用户</h4>
		</#if>
		<div class="tabbable ">
			<ul class="nav nav-tabs">
				<#if user.id?? >
					...
					<li class="active"><a href="#user_role"  id="user_role_tab" data-toggle="tab">维护角色</a></li>
					<#--
				...
				<#else>
					...
					-->ssss
					<li class="active"><a href="#user_role"  id="user_role_tab" onclick="disabeOther()" >维护角色</a></li>
					<#--
					<li><a href="#user_group"  id="user_group_tab" onclick="disabeOther()" ><span style="color:#CDC9A5">维护用户组</span></a></li>
					-->
					<li><a href="#user_position"  id="user_position_tab" onclick="disabeOther()">维护岗位</a></li>
				</#if>
			</ul>
			<!-- 用户基本信息-->
			<div class="tab-content">
						...
						<div class="formSep">
							<div class="row-fluid">
								<div class="span5">
									...
									<div class="span9">
										<select size="1" name="certTypeDic.id" aria-controls="dt_gal"  >
											<option  value="" />请选择..</option>
											<#if user.certTypeDic?? >
								...
								<div class="span5">
									...
									<div class="span9">
										<input id="certNum" name="certNum"  value="${(user.certNum)!""}" />
									</div>
								</div>
							</div>
						</div>
				...
				<div class="tab-pane" id="login"><@token/>
					<#if !userLogin.id??>
						<form  id="loginUserForm" class="form_validation_reg" action="${rc.contextPath}/user/user/opt-update/saveLoginUser.do" method="post"><@token/>
					<#else>
						<form  id="loginUserForm" class="form_validation_reg" action="${rc.contextPath}/user/user/opt-add/saveLoginUser.do" method="post">
					</#if>
					<div class="formSep">
						<div class="row-fluid">
							<div class="span5">
				...
				<!-- 角色-->
				<div class="tab-pane active" id="user_role">
					<#if userRoleList??>
