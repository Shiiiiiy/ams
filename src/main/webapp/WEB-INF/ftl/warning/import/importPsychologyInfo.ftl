...
<html lang="en">
 ...
 <script>
	...
	function goToList() {
		window.location.href="${rc.contextPath}/warning/importPSYCHOLOGY/opt-query/wangingList.do";
	}
...
<div id="contentwrapper">
    <div class="main_content"> 
    	<div class="row-fluid">	
			<form  id="fileUpload" action="${rc.contextPath}/warning/importPSYCHOLOGY/opt-import/importPsychologyInfo.do" method="post" enctype="multipart/form-data">
				...
				<div class="formSep">
					<div class="row-fluid">
							<div class="span6">
								...
								<div class="span9">
									<label><a href="${rc.contextPath}/excel/template/psychologyInfo.xls">模板下载</a></label>
								</div>
							</div>
      		...
      		<#include "comparePsychologyInfo.ftl">
		</div>
