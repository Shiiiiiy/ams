...
<html lang="en">
	<head>
		...
		<script>
			...
			function goToList() {
				window.location.href="${rc.contextPath}/warning/importBEHAVIOR/opt-query/wangingList.do";
			}
	...
	<body>
		<div id="contentwrapper">
			<div class="main_content">
				<div class="row-fluid">
					<form  id="fileUpload"  action="${rc.contextPath}/warning/importBEHAVIOR/opt-query/importBehavior.do" method="post"  enctype="multipart/form-data">
						...
						<div class="formSep">
							<div class="row-fluid">
								<div class="span8">
									...
									<div class="span8">
										<div >
											<a href="${rc.contextPath}/excel/template/import_warning_behavior.xls">行为预警导入模板</a>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="span8">
									...
									<div class="span10" id="_upload_div">
							    		...
							    		<strong>注意!<br/></strong> 
							    			...
							    			2.最大导入行数为1000行。<br/>
											3.导入的各条数据之间不要有空行。<br/>
											4.模版中的学号输入的数据需是当前系统中存在的名称相同。<br/> 
