				...
				<div class="row-fluid">
					<div class="span4">
							<div class="span3"><label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;学院<span class="f_req">*</span></label></div>
							 <select size="1" id="collegeId" name="college.id" aria-controls="dt_gal" class="span7" readonly >
								<option value="${warningForward.college.id}">${warningForward.college.name}</option>
						     </select>
						 </div>
						 <div class="span4">
							<div class="span3"><label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;学年<span class="f_req">*</span></label></div>
							 <select size="1" id="yearId" name="yearDic.id" aria-controls="dt_gal" class="span7"  readonly >
								<option value="${warningForward.yearDic.id}">${warningForward.yearDic.name}</option>
						     </select>
						  </div>
						<div class="span3">
							<div class="span3"><label>学期<span class="f_req">*</span></label></div>
							<select size="1" id="termId" name="termDic.id" aria-controls="dt_gal" class="span8"  readonly >
								<option value="${warningForward.termDic.id}">${warningForward.termDic.name}</option>
						    </select>
						</div>
					</div>
					</div>
					...
					<div class="span4">
							...
							<select size="1" id="warningType" name="warningType.id" aria-controls="dt_gal" class="span7" readonly >
								<option value="${warningForward.warningType.id }">${warningForward.warningType.name}</option>
							   </select>
						 </div>
						 <div class="span4">
