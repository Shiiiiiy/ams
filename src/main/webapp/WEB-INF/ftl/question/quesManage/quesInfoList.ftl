    ...
    <body>
        <div id="contentwrapper">
           <div class="main_content">
             <div class="row-fluid">
               <form  id="quesInfoQuery" action="${rc.contextPath}/question/quesManage/opt-query/quesInfoQuery.do" method="post">
					<div class="span12">			
							<div class="row-fluid">
								<div class="span4">
...
<script>
		//查询
			function queryQuestInfo(){
				$("#quesInfoQuery").attr("action","${rc.contextPath}/question/quesManage/opt-query/quesInfoQuery.do").submit();
			}	
		...
		//查看
			function viewQuesInfo(id){
				$('#quesInfoQuery').attr('action','${rc.contextPath}/question/quesManage/opt-query/quesInfoView.do?id='+id);
				$('#quesInfoQuery').submit();
			}
</script>
</body>
