...
<html lang="en">
 ...
 <script>
	...
	function goToList(){
	    window.location.href="${rc.contextPath}/leave/caucus/opt-query/queryCaucusPage.do";
	}
...
<div id="contentwrapper">
    <div class="main_content"> 
    	<div class="row-fluid">	
			<form  id="fileUpload" action="${rc.contextPath}/leave/caucus/opt-import/importCaucus.do" method="post"  enctype="multipart/form-data">
				 <input type="hidden" name="allowedExt" value="xls"/>
				 <input type="hidden" name="maxSize" value="2097152"/><!--2M-->
				  <div class="formSep">
					<div class="row-fluid">
					  <div class="span9">
						<div class="span2">党团关系导入</div>
						<div class="span8">
					 		<div>
				 				<a href="${rc.contextPath}/excel/template/caucus_import_template.xls">党团关系导入模板</a>
				    		</div>
				    	</div>
				      </div>
			    	</div>
			     ...
			     <div class="formSep">
					 <div class="row-fluid">
						 <div class="span9">						
							<div class="span2">
								<label>党团关系信息<span class="f_req">*</span></label>
							</div>
							<div class="span10" id="_upload_div">					
						         ...
						         <div class="alert alert-warning">
					    		    ...
					    		    <br>6.必填项目：列明标红均为必填项。
					    		    <br>7.导入的数据不做重复校验，若学号相同则更新对应学生的党团关系变动信息。
					    		    <br>8.其中党费交至日期、转出时间、联系电话是按照字符串处理，请在上传是将对应的列转成文本格式。
				    	         </div>							 
						    </div>
						 </div>
					 </div>
				...
				<div class="row-fluid">
					<div class="span9">						
						<div class="span2">&nbsp;</div>
						<div class="span8">
							<button class="btn btn-info" type="button" onclick="importStudentCaucus()">Excel导入</button>
