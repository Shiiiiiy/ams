			...
			<div class="span12">
				...
				<thead>
					<tr>
						...
						<th width="12%">专业</th>
						<th width="8%">离校人数</th>
						<th width="10%">公寓管理中心</br>(已办理/办理率)</th>
						<th width="10%">图书信息中心</br>(已办理/办理率)</th>
						<th width="10%">计财处</br>(已办理/办理率)</th>
						<th width="10%">一卡通</br>(已办理/办理率)</th>
						<th width="10%">组织部</br>(已办理/办理率)</th>
						<th width="10%">保卫处</br>(已办理/办理率)</th>
						<th width="12%">二级学院</br>(已办理/办理率)</th>
					</tr>
				</thead>
				<#-- 选中的数据项ID -->
