...
<form id="reportProgressQuery" action="${rc.contextPath}/leave/handle/opt-query/queryHandleStatisticPage.do" method="post">
...
<script>
	...
	function countReportProgress() {
		$("#reportProgressQuery").attr("action", "${rc.contextPath}/leave/handle/opt-query/queryHandleStatisticPage.do"); 
	...
	function exportEvaluation(){
		...
		if(exportSize==""){
			...
			$("#export_reportProgress").load("${rc.contextPath}/leave/handle/opt-query/nsm/exportHandleStatistic.do?pageTotalCount="+pageTotalCount+"&exportSize="+exportSize);
		}
	};
	
	function exportLeave(exportSize,exportPage){
		$("#reportProgressQuery").attr("action", "${rc.contextPath}/leave/handle/opt-query/exportLeave.do");
