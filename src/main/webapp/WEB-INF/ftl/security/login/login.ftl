...
<script src="${rc.contextPath}/lib/base64/base64.js"></script>
...
<div class="main_right">
	<form action="${rc.contextPath}/loginnocas.do" method="post" id="login_form" onsubmit="return login()">
			<p class="login_top"></p>
			...
			<input name="password" type="password"  id="password" onfocus="passwordfocus()"  placeholder="密码" value="12345678"/>
			</p>
			<div class="yzm"><p class="yzm">
