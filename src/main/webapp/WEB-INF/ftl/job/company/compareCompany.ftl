		...
		<div class="formSep">
			<div class="row-fluid">
				...
				<table class="table table-bordered table-striped tablecut" id="smpl_tbl">
					...
					<tbody id="demo_list">
						<#list exitCompanyinfos as e>
							<tr>
								<td style="text-align:center;vertical-align:middle;">
									<input type="checkbox" name="row_sel" id="${(e[0].companyCode)!""}" class="select_row" onclick="javascript:selectSingle('${(e[0].companyCode)!""}');"/>
								</td>
								<td class="autocut">${(e[0].companyCode)!""?html}</td>
								<td class="autocut">${(e[0].companyName)!""?html}</td>
								<td class="autocut">${(e[0].companyWebsite)!""?html}</td>
								<td class="autocut">${(e[1].companyCode)!""?html}</td>
								<td class="autocut">${(e[1].companyName)!""?html}</td>
								<td class="autocut">${(e[1].companyWebsite)!""?html}</td>
							</tr>
						</#list>
					</tbody>
				</table>
