...
<html lang="en">
	...
	<body>
						...
						<div class="span12">
							...
							<div id="dt_gal_wrapper" class="dataTables_wrapper form-inline" role="grid">
											...
											<div class="row-fluid">
											  <#if user_key.optMap??>
												<#if user_key.optMap['export']??>
										            ...
										            <button class="btn btn-info" type="button" onclick="javascript:exportPoorStudentByClass()">导 出</button>
												</#if>
										     </#if>	
											</div>
										</div>
								...
								<table class="table table-bordered table-striped tablecut" id="smpl_tbl" >
									...
									<tbody>
										<#if poorStudentclassList??>
										    <#assign index = 1/>
											<#assign approvePassNum = 0/>
											<#assign approveRejectNum = 0/>
											<#assign total = 0/>
											<#list poorStudentclassList as r>
												...
												<tr>
													...
													<td class="autocut">${(r.classModel.major.collage.name)!""}</td>
													<td class="autocut">${(r.classModel.major.majorName)!""}</td>
													<td class="autocut">${(r.classModel.className)!""}</td>
											...
											<tr>
												<td class="autocut" colspan="5" style="text-align:center">总计</td>
								...
								<input id="pageTotalCount" name="pageTotalCount" type="hidden"  value="${poorStudentclassList?size}"/>
							</div>
						</div>
					</div>
				</div>
	 ...
	 function exportPoorStudentByClass(){
