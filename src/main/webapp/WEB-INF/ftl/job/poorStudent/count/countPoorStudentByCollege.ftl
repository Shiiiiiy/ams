						...
						<div class="span12">
							...
							<div id="dt_gal_wrapper" class="dataTables_wrapper form-inline" role="grid">
										...
										<div class="dt_actions">
										  ...
										  <#if user_key.optMap??>
											<#if user_key.optMap['export']??>
									            ...
									            <button class="btn btn-info" type="button" onclick="javascript:exportPoorStudentByCollege()">导 出</button>
											</#if>
										  </#if>	
											</div>
										</div>
								...
								<table class="table table-bordered table-striped tablecut" id="smpl_tbl" >
									...
									<tbody>
										<#if poorStudentcollegeList??>
										    <#assign index = 1/>
											<#assign approvePassNum = 0/>
											<#assign approveRejectNum = 0/>
											<#assign total = 0/>
											<#list poorStudentcollegeList as r>
						        ...
						        <input id="pageTotalCount" name="pageTotalCount" type="hidden"  value="${poorStudentcollegeList?size}"/>
							</div>
						</div>
					</div>
				</div>
...
<script type="text/javascript">
	...
	function exportPoorStudentByCollege(){
