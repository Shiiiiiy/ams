...
<html lang="en">
	<head>
		...
		<script>
			...
			function goToList() {
				window.location.href="${rc.contextPath}/job/register/opt-query/registerList.do";
			}
		</script>
	</head>
	...
	<body>
		...
		<div class="main_content">
			<div class="row-fluid">
			<form id="fileUpload" action="${rc.contextPath}/job/register/opt-import/importRegisterCode.do" method="post" enctype="multipart/form-data">
				...
				<div class="formSep">
					<div class="row-fluid">
						<div class="span8">
							...
							<div class="span8">
								<label> <a href="${rc.contextPath}/excel/template/import_register_code.xls">报到证编号导入模板</a> </label>
							</div>
						</div>
					</div>
				</div>
			...
			<#include "compareRegisterCode.ftl">
		</div>
		</div>
		</div>
	</body>
