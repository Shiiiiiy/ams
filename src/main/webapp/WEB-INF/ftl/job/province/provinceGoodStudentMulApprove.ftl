...
<html lang="en">
	...
	<div id="contentwrapper">
	    <div class="main_content">   
			...
			<form  id="stuMulApproveForm"  class="form_validation_reg"  action="${rc.contextPath}/job/approveProvinceGoodStudents/opt-save/saveApproveProvinceGoodStudents.do" method="post">
			    ...
			    <#include "/job/province/selectedProvinceGoodStudentApproveList.ftl">
				 <div class="formSep">
					<div class="row-fluid">
						<div class="span12">
							<div class="span2">
