...
<div id="contentwrapper">
    <div class="main_content"> 
    	<div class="row-fluid">	
			<form  id="fileUpload" action="${rc.contextPath}/student/army/opt-modify/importStudentArmy.do" method="post"  enctype="multipart/form-data">
				 <input type="hidden" name="allowedExt" value="xls"/>
				 <input type="hidden" name="maxSize" value="2097152"/><!--2M-->
				  <div class="formSep">
					<div class="row-fluid">
					  <div class="span9">
						<div class="span2">参军导入模板</div>
						<div class="span8">
					 		<div>
				 				<a href="${rc.contextPath}/excel/template/import_student_army.xls">参军信息导入模板</a>
				    		</div>
				    	</div>
				      </div>
			    	</div>
			     ...
			     <div class="formSep">
					 <div class="row-fluid">
						 <div class="span9">						
							<div class="span2">
								<label>导入参军信息<span class="f_req">*</span></label>
							</div>
							<div class="span10" id="_upload_div">					
						         ...
						         <div class="alert alert-warning">
					    		    ...
					    		    <br>2.最大导入行数为1000行。
					    		    <br>3.导入的各条数据之间不要有空行。
					    		    <br>4.参军信息将以学生的身份证号作为唯一标识进行比对，导入前请确认身份证号无误。
					    		    <br>5.模版中的专业、学生类别，这些列中输入的数据需是当前系统中存在的名称相同。 
					    		    <br>6.删除整行数据时，点击鼠标右键选择"删除"操作，不要用"清除内容"和"Delete"键删除内容。 
					    		    <br>7.必填项目：列明标红均为必填项。
					    		    <br>8.导入的数据如果已经在系统中存在，将采用覆盖更新的方式将原来的数据更新。
				    	         </div>							 
						    </div>
						 </div>
					 </div>
