...
<div id="contentwrapper">
    <div class="main_content"> 
    	<div class="row-fluid">	
			<form  id="fileUpload" action="${rc.contextPath}/league/leagueManage/opt-query/importMember.do" method="post"  enctype="multipart/form-data">
				 ...
				 <input type="hidden" name="classIdText" value="${classIdText!''}"/>
				  <div class="formSep">
					<div class="row-fluid">
					  <div class="span9">
						<div class="span2">团员名单导入模板</div>
						<div class="span8">
					 		<div >
				 				<a href="${rc.contextPath}/excel/template/import_league_member.xls">团员名单导入模板</a>
				    		</div>
				    	</div>
				      </div>
			    	</div>
			      ...
			      <div class="formSep">
					<div class="row-fluid">
						<div class="span9">						
								<div class="span2">
									<label>导入团员名单<span class="f_req">*</span></label>
								</div>
								<div class="span10" id="_upload_div">					
									 ...
									 <div class="alert alert-warning">
							    		...
							    		<br>2.最大导入行数为1000行。
							    		<br>3.导入的各条数据之间不要有空行。
							    		<br>4.团员名单将以学生的学号作为唯一标识进行比对，导入前请确认学号无误。
				...
				<#if !(importFlag??) ||!(page??)>
					<div class="row-fluid">
						<div class="span9">						
							<div class="span2">&nbsp;</div>
							<div class="span8">
								<button class="btn btn-info" type="button" onclick="importMember()">Excel导入</button>
