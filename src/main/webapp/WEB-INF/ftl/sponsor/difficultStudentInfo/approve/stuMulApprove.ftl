...
<html lang="en">
	...
	<div id="contentwrapper">
	    <div class="main_content">   
			...
			<form  id="stuMulApproveForm"  class="form_validation_reg"  action="${rc.contextPath}/sponsor/difficultStudent/opt-save/saveMutiResult.do" method="post">
				<input type="hidden" id="mulResults" name="mulResults"/>
			</form>
			<#include "/sponsor/difficultStudentInfo/approve/selectedStuApproveList.ftl">
