						...
						<#list weekList as d >
							...
							<#if weekMap[weekKey] ??>
								<td class="autocut"  style="text-align:center;vertical-align:middle;">
									<input type="checkbox" disabled  checked="true" name ="lessonCheckBox" id="" value="${lesson.id}_${d.id}"/>
								</td>
							<#else>
								<td class="autocut"  style="text-align:center;vertical-align:middle;">
									<input type="checkbox"  disabled  name ="lessonCheckBox" id="" value="${lesson.id}_${d.id}"/>
								</td>
							</#if>
						</#list>
					</tr>
