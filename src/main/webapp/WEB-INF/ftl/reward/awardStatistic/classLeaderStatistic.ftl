	           			...
	           			<div class="span12">
	           				...
	           				<div id="dt_gal_wrapper" class="dataTables_wrapper form-inline" role="grid">
	           					...
	           					<table class="table table-bordered" id="smpl_tbl">
	           						<thead>
	           							<tr>
	           								<th colspan='7' width="100%" style="text-align: center">${tableTitle!""}</th>
	           							</tr>
										<tr>
	           						...
	           						<#if classList??>
	           							<#list classList as c>
											<tr>
												<td class="autocut" style="text-align: center" style="text-align:center;vertical-align:middle">${c.className!""}</td>
						 				...
						 				<tr>
						 					<td colspan='1' class="autocut" style="text-align: center">合计</td>
