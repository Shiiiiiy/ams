...
<html lang="en">
	<head>
		...
		<script>
			...
			function goToList() {
				window.location.href="${rc.contextPath}/reward/collegeaward/opt-query/queryCollegeAwardPage.do";
			}
	...
	<body>
		<div id="contentwrapper">
			<div class="main_content">
				<div class="row-fluid">
					<form  id="fileUpload"  action="${rc.contextPath}/reward/collegeaward/opt-query/importCollegeAward.do" method="post"  enctype="multipart/form-data">
						...
						<div class="formSep">
							<div class="row-fluid">
								<div class="span8">
									...
									<div class="span8">
										<div >
											<a href="${rc.contextPath}/excel/template/import_reward_collegeAward.xls">校内奖励信息模板</a>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="span8">
									...
									<div class="span10" id="_upload_div">
							    		...
							    		<strong>注意!<br/></strong> 
							    			...
							    			2.最大导入行数为1000行。<br/>
											3.导入的各条数据之间不要有空行。<br/>
											4.模版中的学年、学期、学号，这些列中输入的数据需是当前系统中存在的名称相同。<br/> 
											5.删除整行数据时，点击鼠标右键选择"删除"操作，不要用"清除内容"和"Delete"键删除内容。<br/> 
											6.必填项目：学年、学期、学号。<br/>
											7.导入的数据如果已经在系统中存在，将采用覆盖更新的方式将原来的数据更新。<br/>
							    	</div>
									</div>
								</div>
							</div>
