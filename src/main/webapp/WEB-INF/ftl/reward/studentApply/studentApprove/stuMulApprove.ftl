...
<html lang="en">
	...
	<div id="contentwrapper">
	    <div class="main_content">   
			...
			<form  id="stuMulApproveForm"  class="form_validation_reg"  action="${rc.contextPath}/reward/studentapprove/opt-save/saveMutiResult.do" method="post">
				<input type="hidden" id="mulResults" name="mulResults"/>
			</form>
			<#include "/reward/studentApply/studentApprove/selectedStuApproveList.ftl">
