	...
	<body>
		<div id="contentwrapper">
			<div class="main_content">
				<div class="row-fluid">
					<form  id="fileUpload"  action="${rc.contextPath}/reward/studentapprove/opt-query/importStudentApprove.do" method="post"  enctype="multipart/form-data">
						...
						<div class="formSep">
							<div class="row-fluid">
								<div class="span8">
									...
									<div class="span8">
										<div >
											<a href="${rc.contextPath}/excel/template/import_reward_student_approve.xls">学生评优导入模板</a>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="span8">
									...
									<div class="span10" id="_upload_div">
							    		...
							    		<strong>注意!<br/></strong> 
											...
											3.导入的各条数据之间不要有空行。<br/>
											4.有序列的请选择序列条目。<br/>
											5.模版中的学号、奖项编码，这些列中输入的数据需是当前系统中存在的名称相同。<br/> 
											6.删除整行数据时，点击鼠标右键选择"删除"操作，不要用"清除内容"和"Delete"键删除内容。<br/> 
											7.必填项目：所有标红列都是必填项。<br/>
							    	</div>
									</div>
								</div>
							</div>
