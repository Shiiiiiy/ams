			    			...
			    			<div class="formSep">
			    				<div class="row-fluid">
			    					<div class="span6">
			    				    	...
			    				    	<div class="span4">
											<textarea id="misMatchThing" name="misMatchThing" col="12" rows="3" style="width: 770px; height: 111px;" readonly>${stuInfo.misMatchThing!""}</textarea>
										</div>
		    				    	</div>
			    				</div>
			    			</div>
			    			...
			    			<div class="formSep">
			    				<div class="row-fluid">
			    					<div class="span6">
			    				    	...
			    				    	<div class="span4">
											<textarea id="specialReason" name="specialReason" col="12" rows="3" style="width: 770px; height: 111px;" readonly>${stuInfo.specialReason!""}</textarea>
										</div>
		    				    	</div>
			    				</div>
			    			</div>
			    			...
			    			<div class="formSep">
			    				<div class="row-fluid">
			    					<div class="span6">
			    				    	...
			    				    	<div class="span4">
											<textarea id="personalPerformance" name="personalPerformance" col="12" rows="3" style="width: 770px; height: 111px;" readonly>${stuInfo.personalPerformance!""}</textarea>
										</div>
		    				    	</div>
			    				</div>
			    			</div>
