		...
		<script>
			...
			$("document").ready(function(){
           		attachFlag = $("#stuApplyEdit").compValidate({
					rules:{
						mainEvent:{required:true,maxlength:500}     
					},
					messages:{
						mainEvent:{required:'请填写主要事迹',maxlength:'最多只能输入500字'}
					}
				});
			});
		    	...
		    	<div class="row-fluid">
										...
										<div class="span6">
									    	...
									    	<div class="span4">
									    		<#if (d.conditionName?index_of("BOX") > -1)>
													<input name="${d.conditionName}" value="<#if d.conditionValue == '1'>一等奖学金<#elseif d.conditionValue == '2'>二等奖学金<#elseif d.conditionValue == '3'>三等奖学金</#if>" readonly />
		    			...
		    			<div class="formSep">
		    				<div class="row-fluid">
		    					<div class="span6">
		    						<div class="span4">
		    				    		<span>主要事迹<span class="f_req">*</span></span>
		    						</div>
		    				    	<div class="span4">
										<textarea id="mainEvent" name="mainEvent" col="12" rows="3" style="width: 770px; height: 111px;" >${stuInfo.mainEvent!""}</textarea>
										</br>
