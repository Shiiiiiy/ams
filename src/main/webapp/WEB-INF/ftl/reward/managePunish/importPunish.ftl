	...
	<body>
		<div id="contentwrapper">
			<div class="main_content">
				<div class="row-fluid">
					<form  id="fileUpload"  action="${rc.contextPath}/reward/managepunish/opt-query/importPunish.do" method="post"  enctype="multipart/form-data">
						...
						<div class="formSep">
							<div class="row-fluid">
								<div class="span8">
									...
									<div class="span8">
										<div >
											<a href="${rc.contextPath}/excel/template/import_reward_punish.xls">处分信息模板</a>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="span8">
									...
									<div class="span10" id="_upload_div">
							    		...
							    		<strong>注意!<br/></strong> 
											...
											3.导入的各条数据之间不要有空行。<br/>
											4.有序列的请选择序列条目。<br/>
											5.模版中的学号、处分名称、学年、学期，这些列中输入的数据需是当前系统中存在的名称相同。<br/> 
											6.删除整行数据时，点击鼠标右键选择"删除"操作，不要用"清除内容"和"Delete"键删除内容。<br/> 
											7.必填项目：学号、处分文号、处分名称、处分生效日期、处分失效日期、学年、学期、处分原因。<br/>
											8.导入的数据如果已经在系统中存在，将采用覆盖更新的方式将原来的数据更新。<br/>
							    	</div>
									</div>
								</div>
							</div>
