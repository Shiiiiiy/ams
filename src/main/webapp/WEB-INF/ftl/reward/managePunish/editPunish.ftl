		    			...
		    			<div class="formSep">
		    				<div class="row-fluid">
		    					<div class="span6">
			    					...
			    					<input id="punishId" name="punishId" type="hidden" value="${punishInfo.id}">
			    					<input id="stuIds" name="stuIds" type="hidden" value="${punishInfo.stuId.id!""}">
		    					</div>
		    					<div class="span6">
		    						<div class="span4">
		    				    		<span>处分文号</span>
		    				    	...
		    				    	<div class="span4">
										<input id="punishNum" name="punishNum" value="${punishInfo.punishNum!""}">
									</div>
	    				    	</div>
		    				</div>
	    				</div>
		    			...
		    			<div class="formSep">
		    				<div class="row-fluid">
		    					<div class="span6">
		    				    	...
		    				    	<div class="span4">
										<input id="punishCode" name="punishCode" value="${punishInfo.punishCode!""}">
									</div>
	    				    	</div>
		    					<div class="span6">
		    						<div class="span4">
		    				    	...
		    				    	<div class="span4">
										<input id="punishTypeCode" name="punishTypeCode" value="${punishInfo.punishTypeCode!""}">
									</div>
	    				    	</div>
		    				</div>
		    			</div>	
		    			...
		    			<div class="formSep">
		    				<div class="row-fluid">
	    				    	...
	    				    	<div class="span6">
		    				    	...
		    				    	<div class="span4">
										<input id="punishRepealNum" name="punishRepealNum" value="${punishInfo.punishRepealNum!""}">
									</div>
	    				    	</div>	
		    				</div>
		    			</div>
		    			...
		    			<div class="formSep">
		    				<div class="row-fluid">
		    					<div class="span6">
		    				    	...
		    				    	<div class="span4">
										<textarea id="punishInfo" name="punishInfo" col="12" rows="3" style="width: 770px; height: 111px;">${punishInfo.punishInfo!""}</textarea>
										</br>
		    			...
		    			<div class="formSep">
		    				<div class="row-fluid">
		    					<div class="span6">
		    				    	...
		    				    	<div class="span4">
										<textarea id="punishReason" name="punishReason" col="12" rows="3" style="width: 770px; height: 111px;">${punishInfo.punishReason!""}</textarea>
										</br>
										<font size="1" color="grey"  style="vertical-align:bottom;">(描述不超过500字)</font>
									</div>
	    				    	</div>
		    			...
		    			<div class="formSep">
		    				<div class="row-fluid">
		    					<div class="span6">
		    				    	...
		    				    	<div class="span4">
										<textarea id="comments" name="comments" col="12" rows="3" style="width: 770px; height: 111px;">${punishInfo.comments!""}</textarea>
										</br>
										<font size="1" color="grey"  style="vertical-align:bottom;">(描述不超过500字)</font>
									</div>
	    				    	</div>
		    			...
		    			<div class="formSep">
		    				<div class="row-fluid">
		    					<div class="span6">
		    				    	...
		    				    	<div class="span4">
										<textarea id="examineResult" name="examineResult" col="12" rows="3" style="width: 770px; height: 111px;">${punishInfo.examineResult!""}</textarea>
										</br>
										<font size="1" color="grey"  style="vertical-align:bottom;">(描述不超过500字)</font>
									</div>
	    				    	</div>
