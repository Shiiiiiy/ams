<#if importFlag?? && page??>
<form  id="comparePageQuery" action="${rc.contextPath}/reward/countryaward/opt-query/importCountryData.do" method="post">
	<div class="formSep">
		<div class="row-fluid">
...
<script type="text/javascript">
	...
	function gotoInspectPage(page) {
		jQuery.getJSON("${rc.contextPath}/reward/countryaward/opt-query/compareCountryBurse.do",
			{
				"pageNo":page
			},function(data){
