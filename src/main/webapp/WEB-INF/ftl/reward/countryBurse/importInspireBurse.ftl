...
<html lang="en">
	<head>
		...
		<script>
			...
			function goToList() {
				window.location.href="${rc.contextPath}/reward/inspireaward/opt-query/queryInspireBursePage.do";
			}
	...
	<body>
		<div id="contentwrapper">
			<div class="main_content">
				<div class="row-fluid">
					<form  id="fileUpload"  action="${rc.contextPath}/reward/inspireaward/opt-query/importInspireBurse.do" method="post"  enctype="multipart/form-data">
						...
						<div class="formSep">
							<div class="row-fluid">
								<div class="span8">
									...
									<div class="span8">
										<div >
											<a href="${rc.contextPath}/excel/template/import_reward_inspireBurse.xls">国家奖助导入模板</a>
										</div>
									</div>
								</div>
							</div>
