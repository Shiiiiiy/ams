...
<html lang="en">
	<head>
		...
		<script>
			...
			function goToList() {
				window.location.href="${rc.contextPath}/reward/countryaward/opt-query/queryCountryBursePage.do";
			}
	...
	<body>
		<div id="contentwrapper">
			<div class="main_content">
				<div class="row-fluid">
					<form  id="fileUpload"  action="${rc.contextPath}/reward/countryaward/opt-query/importCountryBurse.do" method="post"  enctype="multipart/form-data">
						...
						<div class="formSep">
							<div class="row-fluid">
								<div class="span8">
									...
									<div class="span8">
										<div >
											<a href="${rc.contextPath}/excel/template/import_reward_countryBurse.xls">国家奖助导入模板</a>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="span8">
									...
									<div class="span10" id="_upload_div">
							    		...
							    		<strong>注意!<br/></strong> 
											...
											3.导入的各条数据之间不要有空行。<br/>
											4.有序列的请选择序列条目。<br/>
											5.模版中的学号、学年，这些列中输入的数据需是当前系统中存在的名称相同。<br/> 
					...
					<#include "compareCountryBurse.ftl">
				</div>
			</div>
		</div>
	</body>
