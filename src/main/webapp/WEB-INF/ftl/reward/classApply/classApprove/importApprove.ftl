	...
	<body>
		<div id="contentwrapper">
			<div class="main_content">
				<div class="row-fluid">
					<form  id="fileUpload"  action="${rc.contextPath}/reward/classapprove/opt-query/importClassApprove.do" method="post"  enctype="multipart/form-data">
						...
						<div class="formSep">
							<div class="row-fluid">
								<div class="span8">
									...
									<div class="span8">
										<div >
											<a href="${rc.contextPath}/excel/template/import_reward_class_approve.xls">班级评优导入模板</a>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="span8">
									...
									<div class="span10" id="_upload_div">
							    		...
							    		<strong>注意!<br/></strong> 
											...
											3.导入的各条数据之间不要有空行。<br/>
											4.有序列的请选择序列条目。<br/>
											5.模版中的班号、奖项编码，这些列中输入的数据需是当前系统中存在的名称相同。<br/> 
