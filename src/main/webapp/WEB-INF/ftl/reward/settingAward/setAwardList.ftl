<html lang="en">
    <head>
		...
		<script>
			//查询
			function query(){
				$("#awardQuery").attr("action","${rc.contextPath}/reward/settingaward/opt-query/queryAwardPage.do?type="+"AWARD");
				$("#awardQuery").submit();
			}
			//新增
			function add(){   
				window.location.href="${rc.contextPath}/reward/settingaward/opt-query/insertAward.do?type=" + "AWARD";
			}
			//修改
			function edit(id){   
    ...
    <body>
		<div id="contentwrapper">
		    <div class="main_content">  
		    	<div class="row-fluid">
		    		<form id="awardQuery" method="post" action="${rc.contextPath}/reward/settingaward/opt-query/queryAwardPage.do">
		    			<div class="span12">
		    				<div class="row-fluid">
		    				    <div class="span4">
		    				   ...
		    				   <div class="span4">
		    				   		<span class="awardType">评奖名称</span>
		    				   		<#if award.awardInfoId ?? && award.awardInfoId.awardName??>
	           					...
	           					<table class="table table-bordered table-striped tablecut" id="smpl_tbl">
	           						<thead>
										<tr>
											...
											<th width="15%" >评奖编码</th>
											<th width="12%" >申请开始日期</th>
											<th width="12%" >申请截止日期</th>
											<th width="8%" >状态</th>
											<th width="8%" >操作</th>
										</tr>
								</thead>
	           							...
	           							<#if page??>	
											<#list page.result as p>
												<tr>
													...
													<td class="autocut" ><#if p.secondAwardName?? && p.secondAwardName.name??>${(p.secondAwardName.name!"")?html}</#if></td>
