...
<html>
    <head>
		...
		<!-- jquery.validate -->
		<script src="${rc.contextPath}/lib/validation/jquery.validate.js"></script>
		<!-- myjs_message_cn -->
		...
		<!--提示框-->
		<script src="${rc.contextPath}/lib/tooltips/jquery.poshytip.js"></script>
		<link rel="stylesheet" href="${rc.contextPath}/lib/tooltips/tip-yellowsimple/tip-yellowsimple.css"/>
		<!--遮罩层-->
