			                        ...
			                        <div class="accordion-inner">
			                            <ul class="nav nav-list">
			                            	<#list sidebarMenu.childList as childMenu>
			                                	...
			                                	<li class="active"><a  onclick="mask.showShade();"  href="${rc.contextPath}/security/menuDispatch.do?menuId=${childMenu.id!}">${childMenu.name}</a></li>
			                                	<#else>
			                                	<li><a  onclick="mask.showShade();"  href="${rc.contextPath}/security/menuDispatch.do?menuId=${childMenu.id!}">${childMenu.name}</a></li>
			                                	</#if>
			                                </#list>
			                            </ul>
			                        </div>
